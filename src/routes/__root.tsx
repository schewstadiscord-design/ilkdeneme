  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Bir şeyler ters gitti. Sayfayı yenilemeyi veya ana sayfaya dönmeyi deneyebilirsiniz.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gebze'nin yeni nesil premium erkek kuaförü. Online randevu alın." },
      { name: "author", content: "ApoFox Digital" },
      { property: "og:title", content: "Saloon Deep — Premium Erkek Kuaförü" },
      { property: "og:description", content: "Gebze'nin yeni nesil premium erkek kuaförü." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@ApoFoxDigital" },
    ],
    links: [
      {
        rel: "stylesheet",
